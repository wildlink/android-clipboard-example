...
![](images/media/image2.png){width="6.5in" height="5.194444444444445in"}

Next, name your project, select Kotlin language and select "Use androidx.\* artifacts. Select Finish.

![](images/media/image3.png){width="6.5in" height="5.222222222222222in"}
...
![](images/media/image5.png){width="6.5in" height="4.486111111111111in"}
...
![](images/media/image10.png){width="6.5in" height="4.472222222222222in"}
...
![](images/media/image1.png){width="3.6666666666666665in" height="1.53125in"}
...
Replace the APP ID and APP SECRET strings with your actual values (contact [[support\@wildlink.me]{.underline}](mailto:support@wildlink.me) if you need credentials created or if you forgot them).
...
![](images/media/image6.png){width="6.5in" height="4.472222222222222in"}
...
![](images/media/image8.png){width="6.5in" height="4.263888888888889in"}
...
![](images/media/image4.png){width="6.5in" height="4.486111111111111in"}
...
![](images/media/image7.png){width="6.5in" height="4.486111111111111in"}
...
![](images/media/image11.png){width="6.5in" height="5.111111111111111in"}
...
![](images/media/image9.png){width="6.5in" height="4.277777777777778in"}
...
You can find the final code for our example in the public Github repository here: [[https://github.com/wildlink/android-clipboard-example]{.underline}](https://github.com/wildlink/android-clipboard-example)
...
You can find examples of both of these behaviors in our [[demo Android app]{.underline}](https://play.google.com/store/apps/details?id=me.wildlink.shareapp&hl=en_US).
...
More information on best practices related to foreground services can be found on the Android Developers Blog: [[https://android-developers.googleblog.com/2018/12/effective-foreground-services-on-android\_11.html]{.underline}](https://android-developers.googleblog.com/2018/12/effective-foreground-services-on-android_11.html)